...
<body>
    ...
    <div id="content">
        ...
        function img_split_jpg()
        {
            ...
            echo "<a href='" . $dir . "split-9.jpg' target='_blank'><img src='" . $dir . "split-9.jpg'></a>";
            echo "<a href='" . $dir . "split-8.jpg' target='_blank'><img src='" . $dir . "split-8.jpg'></a>";
            echo "<a href='" . $dir . "split-7.jpg' target='_blank'><img src='" . $dir . "split-7.jpg'></a><br>";
            echo "<a href='" . $dir . "split-6.jpg' target='_blank'><img src='" . $dir . "split-6.jpg'></a>";
            echo "<a href='" . $dir . "split-5.jpg' target='_blank'><img src='" . $dir . "split-5.jpg'></a>";
            echo "<a href='" . $dir . "split-4.jpg' target='_blank'><img src='" . $dir . "split-4.jpg'></a><br>";
            echo "<a href='" . $dir . "split-3.jpg' target='_blank'><img src='" . $dir . "split-3.jpg'></a>";
            echo "<a href='" . $dir . "split-2.jpg' target='_blank'><img src='" . $dir . "split-2.jpg'></a>";
            echo "<a href='" . $dir . "split-1.jpg' target='_blank'><img src='" . $dir . "split-1.jpg'></a>";
        }
